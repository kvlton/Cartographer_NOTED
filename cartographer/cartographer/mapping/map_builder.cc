...
int MapBuilder::AddTrajectoryBuilder(
  ...
  if (options_.use_trajectory_builder_3d()) {
    ...
    // 2.构造 GlobalTrajectoryBuilder
    // 3.构造 CollatedTrajectoryBuilder
    ...
    // 4. 构造 OverlappingSubmapsTrimmer2D, pose_graph_->AddTrimmer()
  ...
  // 5. 构造 PureLocalizationTrimmer, pose_graph_->AddTrimmer()
